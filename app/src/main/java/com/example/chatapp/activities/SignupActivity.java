...
public class SignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preferenceManager = new com.example.chatapp.utilities.PreferenceManager(getApplicationContext());
        setListeners();
    }
    ...
    private void signUp(){
        ...
        user.put(Constrant.KEY_NAME,binding.inputName.getText().toString());
        user.put(Constrant.KEY_EMAIL,binding.inputEmail.getText().toString());
        user.put(Constrant.KEY_PASSWORD,binding.inputPassword.getText().toString());
        ...
        database.collection(Constrant.KEY_COLLECTION_USERS)
                ...
                .addOnSuccessListener(documentReference -> {
                    ...
                    preferenceManager.putString(Constrant.KEY_NAME,binding.inputName.getText().toString());
